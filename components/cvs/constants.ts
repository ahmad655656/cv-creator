import { User, Briefcase, GraduationCap, Cpu, Globe, Award, FolderGit2 } from 'lucide-react';
import { TemplateConfig } from './types';

export const COLOR_PALETTES = {
  blue: { primary: '#2563eb', secondary: '#7c3aed', accent: '#f59e0b' },
  green: { primary: '#059669', secondary: '#10b981', accent: '#fbbf24' },
  purple: { primary: '#7c3aed', secondary: '#c084fc', accent: '#fcd34d' },
  orange: { primary: '#ea580c', secondary: '#f97316', accent: '#3b82f6' },
  red: { primary: '#dc2626', secondary: '#ef4444', accent: '#6b7280' },
  gray: { primary: '#4b5563', secondary: '#6b7280', accent: '#9ca3af' },
  teal: { primary: '#0d9488', secondary: '#14b8a6', accent: '#f59e0b' },
  indigo: { primary: '#4f46e5', secondary: '#818cf8', accent: '#f43f5e' },
};

export const FONT_OPTIONS = {
  heading: [
    'Inter', 'Poppins', 'Roboto', 'Montserrat', 'Open Sans',
    'Lato', 'Merriweather', 'Playfair Display', 'Times New Roman', 'Georgia'
  ],
  body: [
...
export const SECTIONS = [
  { id: 'personal', name: 'المعلومات الشخصية', icon: User, color: 'blue', description: 'معلومات الاتصال الأساسية' },
  { id: 'experience', name: 'الخبرات المهنية', icon: Briefcase, color: 'green', description: 'خبرات العمل السابقة' },
  { id: 'education', name: 'المؤهلات التعليمية', icon: GraduationCap, color: 'purple', description: 'الشهادات والمؤهلات' },
  { id: 'skills', name: 'المهارات', icon: Cpu, color: 'orange', description: 'المهارات التقنية والشخصية' },
  { id: 'languages', name: 'اللغات', icon: Globe, color: 'indigo', description: 'اللغات ومستوى الإتقان' },
  { id: 'certifications', name: 'الشهادات', icon: Award, color: 'yellow', description: 'الشهادات المهنية' },
  { id: 'projects', name: 'المشاريع', icon: FolderGit2, color: 'red', description: 'المشاريع الشخصية والمهنية' },
];
...
export const TEMPLATES: Record<string, TemplateConfig> = {
  modern: {
    ...
    style: 'modern',
    layout: 'left-sidebar',
    colors: { primary: '#2563eb', secondary: '#7c3aed', accent: '#f59e0b', background: '#ffffff', text: '#1f2937', heading: '#111827' },
  ...
  professional: {
    ...
    style: 'professional',
    layout: 'top-header',
    colors: { primary: '#1e3a8a', secondary: '#334155', accent: '#cbd5e1', background: '#f8fafc', text: '#334155', heading: '#0f172a' },
  ...
  creative: {
    ...
    colors: { primary: '#db2777', secondary: '#6d28d9', accent: '#fbbf24', background: '#ffffff', text: '#1f2937', heading: '#111827' },
    fonts: { heading: 'Poppins', body: 'Open Sans' },
    spacing: { sectionGap: 20, itemGap: 12, padding: 20 },
    showProfileImage: true,
    showSocialLinks: true,
    sections: [
  ...
  minimal: {
    ...
    style: 'minimal',
    layout: 'two-column',
    colors: { primary: '#4b5563', secondary: '#9ca3af', accent: '#6b7280', background: '#ffffff', text: '#374151', heading: '#111827' },
    fonts: { heading: 'Lato', body: 'Lato' },
    spacing: { sectionGap: 16, itemGap: 12, padding: 16 },
  ...
  executive: {
    ...
    style: 'executive',
    layout: 'left-sidebar',
    colors: { primary: '#0f172a', secondary: '#334155', accent: '#f59e0b', background: '#ffffff', text: '#1e293b', heading: '#0f172a' },
    fonts: { heading: 'Playfair Display', body: 'Source Sans Pro' },
    spacing: { sectionGap: 24, itemGap: 18, padding: 24 },
    showProfileImage: true,
    showSocialLinks: true,
    sections: [
  ...
  academic: {
    ...
    style: 'academic',
    layout: 'top-header',
    colors: { primary: '#166534', secondary: '#15803d', accent: '#ca8a04', background: '#ffffff', text: '#1e293b', heading: '#0f172a' },
